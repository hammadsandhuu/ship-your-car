  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 sm:py-5">
        ...
        <div className="block lg:hidden">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-base font-bold" style={{ color: "var(--white)" }}>
            ...
            >
              <Circle className="w-3 h-3 fill-current" style={{ color: "var(--primary)" }} />
          ...
          <div className="relative">
            ...
            >
              <motion.div
                ...
                style={{
                  background: "linear-gradient(90deg, var(--primary) 0%, #a8d916 100%)",
        ...
        {/* Desktop Progress - Professional & Beautiful */}
        <div className="hidden lg:block">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-6">
              <div>
                <h3 className="text-xl font-bold" style={{ color: "var(--white)" }}>
                  Step {currentStep} of {totalSteps}
                </h3>
                <p className="text-sm font-medium" style={{ color: "var(--gray-2)" }}>
                  {stepTitles[currentStep - 1]}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-8">
                ...
                {Array.from({ length: totalSteps }).map((_, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      style={{
                        backgroundColor: isCompleted || isCurrent ? "var(--primary)" : "var(--black-4)",
                        borderColor: isCompleted || isCurrent ? "var(--primary)" : "var(--black-6)",
                        color: isCompleted || isCurrent ? "var(--black)" : "var(--gray-2)",
                        boxShadow: isCurrent
              ...
              >
                <div className="relative">
                  <Circle className="w-4 h-4 fill-current" style={{ color: "var(--primary)" }} />
                  <div
          ...
          <div className="mt-6 relative">
            <div
              ...
              style={{ backgroundColor: "var(--black-5)" }}
            >
              <motion.div
                initial={{ width: 0 }}
                animate={{ width: `${progressPercentage}%` }}
