  ...
  const serviceOptions = [
    {
      ...
      description:
        "Seller delivers goods on board the vessel at the named port of shipment. Buyer assumes responsibility from that point.",
      icon: <Package className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12" />,
      features: [
        "Port delivery",
        "Seller loads goods",
    ...
    },
    {
      ...
      title: "Ex-Works",
      description:
        "Seller makes goods available at their premises. Buyer arranges all transportation and assumes all risks.",
      icon: <CheckCircle className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12" />,
      features: [
        "Factory pickup",
        "Minimal seller risk",
        "Buyer full control",
        "Cost effective for buyer",
      ],
    ...
    },
    {
      ...
      title: "Door-to-Door",
      description:
        "Complete service from seller's location to buyer's destination. Full logistics management included.",
